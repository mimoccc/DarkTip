...
DarkTip = {
	...
	'base': {
		'Module': {
			...
			'aaa': function(aaa) { alert('aaa: ' + aaa); },
			'bbb': function(bbb) { alert('bbb: ' + bbb); },
			'ccc': function(ccc) { alert('ccc: ' + ccc); }
		}
	},
	...
	{
		this.__proto__ = DarkTip.base.Module;

		// jQuery merge init array into this
	},
	...
	'initialize': function()
	{
		yepnope({
			'test'    : window.jQuery,
			'nope'    : 'http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js',
			'complete': function()
			{
				DarkTip.jQuery = jQuery.noConflict(true);
			}
		});
	...
	{
		var module = new DarkTip.Module(settings);
		return module;
	},
	...
	'cacheHighLevel': function(module, trigger, result)
	{
		...
		{
			// return cache for module and trigger combo
		}
	},
...
var test = DarkTip.registerModule({
	'ccc': function(ccc) { alert('own ccc: ' + ccc); },
	'options': {
		'aaa': 999 // this needs to be handled to __proto__
	}
});

console.log(window.jQuery);
console.log(window.DarkTip);