var DarkTip = (function (window, document, undefined) {
	...
	var DarkTip = {
		...
		'isUndefined': DarkTipFactory.makePrototypeCheck('[object Undefined]'),
		'isNumber'   : DarkTipFactory.makePrototypeCheck('[object Number]'),
		'isString'   : DarkTipFactory.makePrototypeCheck('[object String]'),
		'isRegExp'   : DarkTipFactory.makePrototypeCheck('[object RegExp]'),
		'isArray'    : DarkTipFactory.makePrototypeCheck('[object Array]'),
		'isFunction' : DarkTipFactory.makePrototypeCheck('[object Function]'),
		'isObject'   : DarkTipFactory.makePrototypeCheck('[object Object]'),
